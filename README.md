# Coffee Machine
**A JetBrains Academy Project. Implement a coffee machine programe.**

The programe asks for user input to choose working mode. You can buy coffee, fill the coffee machine with supply, take the money earned by coffee machine and ask the machine to print out the materials it has. It also examine how much coffee it can make before any purchase.
...
# Future work
Refactor the code so that it is more readable and follow the rules of OOP. It only has one method to receive user input.
